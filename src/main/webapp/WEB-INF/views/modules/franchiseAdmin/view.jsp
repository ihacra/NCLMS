...
<body>
<form:form id="inputForm" modelAttribute="franchiseAdmin" action="${ctx}/admin/franchise/view" method="post" cssClass="sui-form form-horizontal">
    <form:hidden path="id"/>
    <div class="main-con">
        <br/>
        ...
        <c:if test="${not empty franchiseAdmin.status}">
            <div class="control-group">
                <div class="controls">审核结果：${franchiseAdmin.status}</div>
            </div>
        </c:if>
        <c:if test="${not empty franchiseAdmin.remarks}">
            <div class="control-group">
                <div class="controls">审核意见：${franchiseAdmin.remarks}</div>
            </div>
        </c:if>
        <hr/>
        <div class="control-group">
