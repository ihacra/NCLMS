...
<form:form id="inputForm" modelAttribute="userAdmin" action="${ctx}/admin/user/save" method="post" cssClass="sui-form form-horizontal sui-validate">
    ...
    <div class="main-con">
        ...
        <div class="control-group">
            <label class="control-label req">性别：</label>
            <div class="controls">
        ...
        <div class="control-group">
            <label for="birth" class="control-label req">出生日期：</label>
            <div class="controls">
        ...
        <div class="control-group">
            <label for="mobile" class="control-label req">联系方式：</label>
            <div class="controls">
                <form:input path="mobile" maxlength="20" placeholder="请输入联系方式" data-rules="mobile"/>
            </div>
        </div>
        <div class="control-group">
            <label for="mail" class="control-label req">电子邮箱：</label>
            <div class="controls">
                <form:input path="mail" maxlength="32" placeholder="请输入邮箱" data-rules="email"/>
            </div>
        </div>
        <div class="control-group">
            <label for="address" class="control-label req">居住地址：</label>
            <div class="controls">
