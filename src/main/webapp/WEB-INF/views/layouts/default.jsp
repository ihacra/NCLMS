...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${path}/static/custom/custom_cms-1.0.0.css"/>
    <script type="text/javascript" src="${path}/static/custom/custom_cms-1.0.0.js"></script>
